...
################################################DYNAMIC####################################################
    H_ee_camera = detector.get_H_ee_camera()
    start_position_D = np.array([-0.01779206+pi/2+pi/16, -0.76012354,  0.01978261, -2.34205014, 0.02984053, 1.54119353+pi/4, 0.75344866]) ############ TO BE MEASURED
    ...
    # mid_grab_pos = (pre_grab_pos + grab_pos) / 2
    ...
    def is_block_grabbed(arm):
        ...
        # print(forces)
        return 0.045 <= width <= 0.07 # Simulation
